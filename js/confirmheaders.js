jQuery(document).ready(function() {
    ...
    jQuery("#genupdate").click(function(){
        ...
        var arr = ["Voylite Serial Number ( VSN )","Category","Color","size","Stock Quantity","Priority","Bulb Included","lumen","Fixture Material","Light Direction","No. of bulbs"];
        var indexarr = ["sku","categories","color","size","qty","priority","with_bulb","lumen","finish","light_direction","number_of_bulbs"];
